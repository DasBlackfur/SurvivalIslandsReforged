package gay.blackfur.survivalisland.noise;

import gay.blackfur.survivalisland.util.CachedQueryableGrid2D;
import gay.blackfur.survivalisland.util.RoundedQueryShape;
...
public class IslandContinentalNoise {
    ...
    private static final double GRID_CELL_SIZE_SPACING_MULTIPLIER = Mth.sqrt(2);

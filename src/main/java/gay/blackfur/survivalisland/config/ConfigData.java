package gay.blackfur.survivalisland.config;

import gay.blackfur.survivalisland.noise.OctaveNoiseRecipe2D;
import gay.blackfur.survivalisland.util.FloatRange;
